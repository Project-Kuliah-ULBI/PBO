...
namespace SiJabarApp
{
    public partial class Form1 : Form
    {
        ...
        private void BtnActionLogin_Click(object sender, EventArgs e)
        {
            ...
            string msg, username;
            bool success = dbHelper.LoginUser(txtLogEmail.Text, txtLogPass.Text, out msg, out username);

            if (success) MessageBox.Show($"Selamat Datang, {username}!", "Login Sukses");
            else MessageBox.Show(msg, "Login Gagal", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
